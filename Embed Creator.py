...
os.system('cls')
print(center(f"{Fore.RED}[!] Oublier pas d'installer les Modules !"))
time.sleep(1)
os.system('cls')
time.sleep(1)
...
if desc == 'y':
    ...
    ask_import = input(f"{Fore.WHITE}[?] Avez vous enter votre desc dans le code au prealable (y/n) > ")


    if ask_import == 'n':
        manual_desc = input(f"{Fore.WHITE}[?] Description > ")
        desc1 = manual_desc
